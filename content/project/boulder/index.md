...
{{< img src="/img/reu/boulder/flight_path.png" alt="a map showing the flight path of the nasa planes" >}}
...
{{< img src="/img/reu/boulder/raw.png" alt="an image of a blue circle with dark red and yellow coloring around certain edges." >}}
*Raw imaging of the corona from the NASA planes in IR (Image credit: Dan Seaton, Amir Caspi)* 


## Results
We focused mainly on the active region and prominence. Below are pictures
of the prominence and active region in different wavelengths (HI, Si IX + X, Mg VIII), showing different spatial distribution and morphology of  each spectral line. 



{{< img src="/img/reu/boulder/RESULTS.png" alt="a set of images of the solar prominence and active region in different wavelengths" >}}
